...
task_1.task = Task(1)
task_2 = Item(8, 2, "task")
task_2.task = Task(2)
task_3 = Item(9, 2, "task")
task_3.task = Task(3)

items_on_map.add(task_1)
items_on_map.add(task_2)
...
table = Item( 13, 3, "table")
table.task = Task(2)
items_on_map.add(table)

table = Item( 15, 3, "table")
table.task = Task(2)
items_on_map.add(table)
...
apple_1 = Item(10,2, "apple")
apple_2 = Item(10,7, "apple")
apple_3 = Item(15,7, "apple")
apple_4 = Item(3,3, "apple")
apple_5 = Item(4,22, "apple")

items_on_map.add(apple_1)
items_on_map.add(apple_2)
items_on_map.add(apple_3)
items_on_map.add(apple_4)
items_on_map.add(apple_5)

book_1 = Item(4,23, "book")
book_2 = Item(6,24, "book")
book_3 = Item(16,7, "book")

items_on_map.add(book_1)
items_on_map.add(book_2)
items_on_map.add(book_3)
